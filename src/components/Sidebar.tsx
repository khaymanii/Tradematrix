...
export default function Sidebar() {
  return (
    <div className="max-w-screen-xl mx-auto">
      <div className=" h-screen py-8 px-2 w-72 bg-gray-700 rounded-2xl cursor-pointer">
        <div className="flex flex-col gap-[410px]">
          <div>
            {" "}
            <div className="flex items-center gap-2 mb-2 bg-green-600 w-56 py-2 px-4 rounded-xl">
              <Image
            ...
            <div className="flex items-center gap-2 mb-2 hover:bg-green-600 w-56 py-2 px-4 rounded-xl">
              ...
              <p className="text-xs text-white">Out bot</p>
            </div>
            <div className="flex items-center gap-2 mb-2 hover:bg-green-600 w-56 py-2 px-4 rounded-xl">
              <Image
